# This file is the entry point for the CLI application.
# It need a different set of credentials than the web app.
...
if not creds or not creds.valid:
    if creds and creds.expired and creds.refresh_token:
        ...
        flow = InstalledAppFlow.from_client_secrets_file("cli_credentials.json", SCOPES)
